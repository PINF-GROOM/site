...
<header>
    <a href="/"><img src="{{ Vite::asset('resources/assets/logo/long-name.svg') }}" alt="Logo Vincent Masseron"></a>
    <div id="burgerMenu">
        <input id="burgerButton" type="checkbox" />
        <span></span>
        <span></span>
        <span></span>
    </div>
        ...
        <div>
            <div class="languageIcon">
                ...
                <div class="languageChoice">
                    <img class="languageChoiceIcon languageSelectFr" src="{{ Vite::asset('resources/assets/icons/flags/france.svg') }}"
                        alt="France flag">
                    <img class="languageChoiceIcon languageSelectEn" src="{{ Vite::asset('resources/assets/icons/flags/uk.svg') }}"
                        alt="United Kingdom flag">
                    <img class="languageChoiceIcon languageSelectEs" src="{{ Vite::asset('resources/assets/icons/flags/spain.svg') }}"
                        alt="Spain flag">
                    <img class="languageChoiceIcon languageSelectDe" src="{{ Vite::asset('resources/assets/icons/flags/germany.svg') }}"
                        alt="Germany flag">
                </div>
            </div>
        </div>
