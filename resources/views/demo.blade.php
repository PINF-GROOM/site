...
<input disabled type="text" placeholder="Input de texte" />

<div class="inputIcon disabled">
    <img src="{{ Vite::asset('resources/assets/icons/user.svg') }}">
    <input disabled type="text" placeholder="Input de texte" />
</div>

<input disabled class="inputShadow" type="text" placeholder="Input de texte" />

<div class="inputIcon inputShadow disabled">
<img src="{{ Vite::asset('resources/assets/icons/user.svg') }}">
<input disabled type="text" placeholder="Input de texte" />
</div>
