    ...
    <div id="content" style="display: flex; flex-direction: column; gap: 20px; padding: 100px;">
        <div style="display: flex; gap: 10px;">
            ...
            <div style="display:  flex; flex-direction: column; gap: 10px;">
                <button class="classicButton buttonCalendarNextMonth">Suivant</button>
                <button class="classicButton buttonCalendarPreviousMonth">Précédent</button>
                <button class="classicButton buttonCalendarClear">Supprimer sélection</button>
                <button class="classicButton buttonCalendarCurrentMonth">Revenir au mois courant</button>
            </div>
        </div>
    </div>
