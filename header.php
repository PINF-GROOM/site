...
<head>
    ...
    <link rel='stylesheet' href='stylesheets/utils.css' type='text/css' media='screen' charset='utf-8' />
    <script type="text/javascript" src="scripts/assets.js"></script>
    <link rel='stylesheet' href='stylesheets/assets.css' type='text/css' media='screen' charset='utf-8' />
</head>

<body onload="initAssets(); initUtils();">
    <header>
        <a href="index.html"><img src="assets/logo/long-name.svg" alt="Logo Vincent Masseron"></a>
        <div>
            <nav>
            ...
            <div>
                <div id="languageIcon" onclick="toggleLanguage();">
                ...
                <div id="languageChoice">
                    <img class="langSelector" src="assets/icons/flags/fr.svg" alt="France flag" data-country="fr">
                    <img class="langSelector" src="assets/icons/flags/uk.svg" alt="United Kingdom flag"  data-country="en">
                    <img class="langSelector" src="assets/icons/flags/es.svg" alt="Spain flag"  data-country="es">
                    <img class="langSelector" src="assets/icons/flags/de.svg" alt="Germany flag"  data-country="de">
                </div>
            </div>
        </div>
    </header>
